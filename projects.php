...
<body>
    ...
    <div class="bodyBackground">
        ...
        <p class="projectsPara">Enchanted Moments</p>
        <a href="/docs/EnchantedMomentsUIUX.pdf" class="projectsPara" target="_blank">Click here to view a PDF of Enchanted Moments UI/UX</a><br>
